          ...
          <div className="pt-4 border-t border-slate-800/80 space-y-2.5">
            ...
            <div className="grid grid-cols-1 gap-2">
              <button
                ...
                className="flex items-center justify-between p-2 rounded-xl bg-slate-950/60 hover:bg-slate-800/80 border border-slate-800 hover:border-cyan-500/40 text-left transition cursor-pointer group"
              >
                <div className="flex items-center gap-2.5">
                  <div className="h-7 w-7 rounded-lg bg-red-500/10 text-red-400 border border-red-500/20 flex items-center justify-center shrink-0">
                    <ShieldCheck className="h-3.5 w-3.5" />
                  </div>
                  <div>
                    <div className="text-xs font-semibold text-slate-200 group-hover:text-white">Admin Master</div>
                    <div className="text-[10px] text-slate-400">admin@netpulse.com</div>
                  </div>
                </div>
              ...
              <button
                type="button"
                onClick={() => handleQuickLogin('operador@netpulse.com', 'operador123')}
                className="flex items-center justify-between p-2 rounded-xl bg-slate-950/60 hover:bg-slate-800/80 border border-slate-800 hover:border-cyan-500/40 text-left transition cursor-pointer group"
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-slate-200 group-hover:text-white">Operador NOC</div>
                    <div className="text-[10px] text-slate-400">operador@netpulse.com</div>
                  </div>
                </div>
                <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-slate-900 text-slate-400 border border-slate-800">
                  Preencher
              ...
              <button
                type="button"
                onClick={() => handleQuickLogin('diretoria@netpulse.com', 'diretoria123')}
                className="flex items-center justify-between p-2 rounded-xl bg-slate-950/60 hover:bg-slate-800/80 border border-slate-800 hover:border-cyan-500/40 text-left transition cursor-pointer group"
              >
                <div className="flex items-center gap-2.5">
                  <div className="h-7 w-7 rounded-lg bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 flex items-center justify-center shrink-0">
                    <Eye className="h-3.5 w-3.5" />
                  </div>
                  <div>
                    <div className="text-xs font-semibold text-slate-200 group-hover:text-white">Diretoria (Viewer)</div>
                    <div className="text-[10px] text-slate-400">diretoria@netpulse.com</div>
                  </div>
                </div>
                <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-slate-900 text-slate-400 border border-slate-800">
                  Preencher
